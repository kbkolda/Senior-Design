...
$sql = "SELECT username, firstname, lastname FROM staff WHERE archive = 1";
...
if ($result->num_rows > 0) 
{
	...
	//	$sql2 = "SELECT firstname, lastname FROM staff WHERE username = $userid";
    //	$result2 = $conn->query($sql2);
	//	$row2 = $result2->fetch_assoc();
      //  echo "<tr><td>" . $userid. "</td><br>";
...
function dropdown(id)
{
	...
	{
		window.location = "staffarchive.php";
	}
}
</script>
</body>
