...
$sql = "SELECT events.child,events.user,events.start,events.end,children.dob from events
INNER JOIN children on events.user = children.parentID";
...
$workbook->send('Daily Schedule.xls');
