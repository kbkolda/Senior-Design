...
if(isset($_SESSION['selectusercalendar']))
{
    $userselect = $_SESSION['selectusercalendar'];
    $sql = "SELECT id,title,start,end,color FROM events WHERE user = '$userselect';";
}
else
{
...
<html lang="en">
    ...
    <div class="panel-body">
          <form class="form-horizontal row-border" method= "POST" action="selectusercalendar.php">
            <div class="form-group">
            <label class="col-md-2 control-label">User Name</label>
            <div class="col-md-10">
            <select class="form-control" name="selectusercalendar">
                          <?php
                            ...
                            //$sql = "SELECT userinfo.firstname, userinfo.lastname FROM user INNER JOIN userinfo ON user.userID=userinfo.userID WHERE user.archive = 0 ORDER BY userinfo.lastname";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Peace Brookings Calendar: <?php echo $_SESSION['selectusercalendar'];?></h1>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="/admin/user/selectaddevent.php">
					...
					<div class="col-sm-10">
					  <select name="child" class="form-control" id="child">
							<?php
									...
									$conn = mysqli_connect('localhost','peacebr2_user','dbuser','peacebr2_db')or die("cannot connect"); 	
									$theuser = $_SESSION['selectusercalendar'];
