...
$sql = "SELECT archive FROM user WHERE user = '$username'";
$result2 = mysqli_query($conn,$sql);
$arc = mysqli_fetch_object($result2);
$arc = $arc->archive;


if(password_verify($password,$hash) && $arc == 0)
{
    session_start();
    $_SESSION['loggedin'] = true;
    $_SESSION['username'] = $username;
    $_SESSION['errors'] = null;
    header("Location:http://peacebrookingscalendar.org/user/index2.php");}
else
{
   $_SESSION['errors'] = array("Your username or password was incorrect.");
